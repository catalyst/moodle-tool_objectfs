...
- **Minimum size threshold**: Minimum size threshold for transferring objects to remote object storage. If objects are over this size they will be transferred.
...
- **Minimum size for Pre-Signed URL**: Minimum file size required to redirect requests to an external storage.
