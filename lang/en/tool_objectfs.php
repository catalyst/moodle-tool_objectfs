...
$string['object_status:location:orphaned'] = 'Marked as orphaned';
...
$string['settings:maxorphanedage_help'] = 'If set to zero, this will not delete old orphaned/orphaned metadata for objects. Otherwise, it will remove these records as they are no longer relevant. An orphaned/orphaned object is one where the metadata exists on the {tool_objectfs_objects} table but referenced file no longer exists.';
