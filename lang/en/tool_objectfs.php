...
$string['object_status:location:deltasizechart'] = 'Delta (MB)';
...
$string['object_status:location:externalsizechart'] = 'External (MB)';
$string['object_status:location:filedircount'] = 'Filedir (count)';
$string['object_status:location:filedirsize'] = 'Filedir (size)';
$string['object_status:location:filedirsizechart'] = 'Filedir (MB)';
...
$string['object_status:location:localsizechart'] = 'Local (MB)';
...
$string['object_status:location:missingsizechart'] = 'Error (MB)';
...
$string['object_status:location:orphanedsizechart'] = 'Orphaned (MB)';
...
$string['object_status:location:totalsizechart'] = 'Total (MB)';
...
$string['settings:enableexternalreadfallback'] = 'Enable external read fallback';
$string['settings:enableexternalreadfallback_help'] = 'When enabled, if a file cannot be read from the primary external store, objectfs will dispatch a hook allowing sub-plugins to resolve the file from an alternative store. This adds a HEAD request per file serve and should only be enabled when multiple stores are configured.';
...
$string['settings:minorphanedage'] = 'Minimum Moodle orphaned file age';
$string['settings:minorphanedage_help'] = 'Minimum age for a Moodle orphaned file to be deleted from the filedir. A Moodle orphaned file is that which exists on disk but is not referenced in mdl_files.';
