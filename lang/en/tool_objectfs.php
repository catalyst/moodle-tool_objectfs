...
$string['settings:presignedurl:presignpublicurls'] = 'Pre-Sign files with public long-lived cache headers';
$string['settings:presignedurl:presignpublicurls_help'] = 'By default files with Cache-Control directives that are public and either immutable or have max-age of 30 days or more will not be redirected to Pre-Signed urls.';
