...
$string['delete_archived_object_metadata_task'] = 'Object file system delete orphaned metadata task';
...
$string['archive_orphaned_objects_task'] = 'Object file system archive orphaned objects task';
...
$string['object_status:location:archived'] = 'Marked as archived';
...
$string['object_status:location:archivedcount'] = 'Archived (count)';
$string['object_status:location:archivedsize'] = 'Archived (size)';
...
$string['settings:maxarchivedage'] = 'Max archived object age';
$string['settings:maxarchivedage_help'] = 'If set to zero, this will not delete old archived/orphaned metadata for objects. Otherwise, it will remove these records as they are no longer relevant. An archived/orphaned object is one where the metadata exists on the {tool_objectfs_objects} table but referenced file no longer exists.';
