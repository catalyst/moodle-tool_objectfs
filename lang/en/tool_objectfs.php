...
$string['settings:presignedurl:externalvalidation'] = 'External Validation Method';
$string['settings:presignedurl:externalvalidation_help'] = 'Validates that we can use presigned URLs for file<br/><ul><li>External - query the external resource to see if the item exists</li><li>DB - Query database to see where the location is</li></ul>';
$string['settings:presignedurl:agevalidation'] = 'Auto Validate on Age';
$string['settings:presignedurl:agevalidation_help'] = 'Automatically assumes files older than this time can be accessed externally. If 0, this is not used.';
