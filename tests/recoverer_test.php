...
class recoverer_testcase extends tool_objectfs_testcase {
    ...
    protected function setUp() {
        parent::setUp();
        $this->candidatesfinder = new candidates_finder(recoverer::class, test_config::instance());
        $this->logger = new \tool_objectfs\log\aggregate_logger();
        $this->recoverer = new recoverer($this->filesystem, test_config::instance(), $this->logger);
        ob_start();
    }
